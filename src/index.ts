...
import type { NitroSystemNavigationBar } from './specs/NitroSystemNavigationBar.nitro'

const NitroSystemNavigationBarHybridObject =
  NitroModules.createHybridObject<NitroSystemNavigationBar>(
...
export function setNavigationBarColor(
  ...
  NitroSystemNavigationBarHybridObject.setNavigationBarColor(
    color,
    isTranslucent
  )
}
